...
export default function KingsCastlePage() {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex items-center gap-2 sm:gap-3 mb-2">
            ...
            <h1 className="text-2xl sm:text-4xl font-bold text-secondary">King Palace</h1>
          </div>
          <p className="text-xs sm:text-base text-muted-foreground">Exclusive marketplace for hostel boys</p>
        </div>
